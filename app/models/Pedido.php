...
class Pedido
{
    ...
    {        
        ...
        $query = $objDataAccess->prepareQuery("INSERT INTO Pedidos (codigo_pedido, estado, id_empleado, id_mesa, id_producto, nombre_cliente, tiempo_estimado, horario_inicio, horario_fin) VALUES (:codigo_pedido, :estado, :id_empleado, :id_mesa, :id_producto, :nombre_cliente, :tiempo_estimado, :horario_inicio, :horario_fin)");
    ...
    {
        $objDataAccess = DataAccess::getInstance();
        $query = $objDataAccess->prepareQuery("SELECT id, codigo_pedido, estado, id_empleado, id_mesa, id_producto, nombre_cliente, tiempo_estimado, horario_inicio, horario_fin FROM Pedidos WHERE id = :id");
    ...
    {
        $objDataAccess = DataAccess::getInstance();
        $query = $objDataAccess->prepareQuery("SELECT id, codigo_pedido, estado, id_empleado, id_mesa, id_producto, nombre_cliente, tiempo_estimado, horario_inicio, horario_fin FROM Pedidos");
        $query->execute();
